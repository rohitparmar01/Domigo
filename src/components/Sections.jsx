      ...
      <motion.div variants={reveal} className="mt-8">
        <motion.button 
          whileHover={{
            scale:1.05,
            y: -3,
            boxShadow: "0 12px 32px rgba(35, 114, 173, 0.3)"
          }} 
          whileTap={{scale:0.97}} 
          transition={{ type: "spring", stiffness: 400, damping: 17 }}
          onClick={onPrimary} 
          className="px-6 py-3 btn-primary rounded-2xl text-base md:text-lg font-semibold"
        >
          Book Free Trial
        </motion.button>
      </motion.div>
...
export function WhatIsTrial({ onPrimary }){
  return (
    <motion.section 
      className="bg-white/50 max-w-6xl mx-auto px-6 py-14 rounded-2xl card-shape" 
      initial="hidden" 
      whileInView="visible" 
      viewport={{once:true, margin: "-100px"}}
      variants={containerVariants}
...
export function Benefits({ onPrimary }){
  ...
  return (
    ...
    >
      <motion.h3 
        variants={reveal}
        className="text-3xl md:text-4xl font-bold text-lagoon text-center mb-10 tracking-tight" 
        style={{ fontFamily: 'Quicksand, sans-serif' }}
      >
        ...
        {cards.map((c,i)=> (
          <motion.div
            ...
            whileHover={{ 
              scale: 1.05, 
              y: -10, 
              boxShadow: '0 16px 48px 0 rgba(30, 64, 175, 0.18)' 
            }}
      ...
      <motion.div variants={reveal} className="mt-10 text-center">
        <motion.button 
          whileHover={{
            scale:1.05,
            y: -3,
...
export function Process({ onPrimary }){
  ...
  return (
    <motion.section 
      id="what-happens" 
      className="bg-white/50 max-w-4xl mx-auto px-6 py-16 rounded-2xl card-shape scroll-mt-24" 
      initial="hidden" 
      whileInView="visible" 
      viewport={{once:true, margin: "-100px"}}
      variants={containerVariants}
        ...
        {steps.map((s,i)=> (
          <motion.div
            ...
            whileHover={{ 
              scale: 1.02, 
              y: -5, 
              boxShadow: '0 12px 38px 0 rgba(30, 64, 175, 0.15)' 
            }}
    ...
    >
      <div className="grid md:grid-cols-2 gap-10 items-center">
        <div>
          <motion.h3 
            variants={reveal}
            className="text-3xl md:text-4xl font-bold text-lagoon mb-4 leading-tight" 
            style={{ fontFamily: 'Quicksand, sans-serif' }}
          >
          ...
          <motion.p 
            variants={reveal}
            className="mt-3 text-lg md:text-xl text-black/80 max-w-2xl" 
            style={{ fontFamily: 'Quicksand, sans-serif', lineHeight: '1.7' }}
          >
          ...
          <motion.div variants={reveal} className="mt-8">
            <motion.button 
              ...
              transition={{ type: "spring", stiffness: 400, damping: 17 }}
              onClick={onPrimary} 
              className="px-7 py-4 btn-primary rounded-2xl text-base md:text-lg font-semibold"
            >
              Book Free Trial
            </motion.button>
          </motion.div>
...
export function SocialProof({ onPrimary }){
  ...
  return (
    <motion.section 
      className="bg-white/50 max-w-6xl mx-auto px-6 py-16 rounded-2xl card-shape" 
      initial="hidden" 
      whileInView="visible" 
      viewport={{once:true, margin: "-100px"}}
      variants={containerVariants}
...
export function WhoShouldBook({ onPrimary }){
  return (
    ...
    >
      <motion.div 
        variants={reveal}
        className="bg-white rounded-2xl shadow-xl p-0 w-full grid grid-cols-1 md:grid-cols-2 items-center" 
        style={{ boxShadow: '0 4px 24px 0 rgba(30, 64, 175, 0.07)' }}
      >
        <motion.div 
        ...
        <div className="flex flex-col items-center p-6 md:p-10">
          <motion.h3 
            variants={reveal}
            className="text-3xl md:text-4xl font-bold text-lagoon text-center mb-6 tracking-tight" 
            style={{ fontFamily: 'Quicksand, sans-serif' }}
          >
...
export function Differentiation({ onPrimary }){
  return (
    <motion.section 
      className="bg-white/50 max-w-5xl mx-auto px-6 py-12 rounded-2xl card-shape" 
      initial="hidden" 
      whileInView="visible" 
      viewport={{once:true, margin: "-100px"}}
      variants={containerVariants}
    >
      <motion.h3 
        variants={reveal}
        className="text-3xl md:text-4xl font-bold text-lagoon mb-4" 
        style={{ fontFamily: 'Quicksand, sans-serif' }}
      >
      ...
      <motion.div variants={reveal} className="mt-8 text-center">
        <motion.button 
          whileHover={{
            scale:1.05,
            y: -3,
...
export function FAQ({ onPrimary }){
  ...
  return (
    <motion.section 
      id="faq" 
      className="max-w-4xl mx-auto px-6 py-12 scroll-mt-24 flex flex-col items-center" 
      initial="hidden" 
      whileInView="visible" 
      viewport={{once:true, margin: "-100px"}}
      variants={containerVariants}
    >
      <motion.h3 
        variants={reveal}
        className="text-3xl md:text-4xl font-bold text-lagoon mb-6 tracking-tight text-center" 
        style={{ fontFamily: 'Quicksand, sans-serif' }}
      >
        FAQ
      </motion.h3>
      <div className="mt-4 space-y-4 w-full flex flex-col items-center">
        {qas.map(([q,a],i)=> (
          <motion.div 
            ...
            variants={reveal} 
            custom={i} 
            className="p-6 bg-white card-shape cursor-pointer select-none w-full max-w-3xl" 
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <motion.span 
                className={`ml-4 text-2xl ${open===i ? 'text-lagoon' : 'text-black/40'}`}
      ...
      <motion.div variants={reveal} className="mt-6 text-center w-full">
        <motion.button 
          whileHover={{
            scale:1.05,
            y: -3,
          ...
          transition={{ type: "spring", stiffness: 400, damping: 17 }}
          onClick={onPrimary} 
          className="px-6 py-3 btn-primary rounded-2xl"
        >
          Book Free Trial
        </motion.button>
      </motion.div>
...
export function RepeatingText(){
  return (
    <motion.div 
      className="max-w-5xl mx-auto px-6 py-6 text-center text-black/50"
      initial={{ opacity: 0 }}
      whileInView={{ opacity: 1 }}
      viewport={{ once: true }}
      transition={{ duration: 0.6 }}
    >
      Boarding feels better when it doesn't feel new.
    </motion.div>
  )
}
